...
nii_path = "data/test/images"  # path to the nii images
gt_path = "data/tes" \
          "t/labels"  # path to the ground truth
npy_path = "data/npy2/" + prefix[:-1]
...
for name in tqdm(names[:115]):  # use the remaining 10 cases for validation
